...
mod tests {
    ...
    #[tokio::test]
    async fn outer_focus_gained_preserves_done_markers() {
        let mut app = test_app();
        let mut workspace = Workspace::test_new("test");
        ...
        // Regaining OS focus must not clear done markers: they persist as inbox
        // items until each agent is addressed (starts working again).
