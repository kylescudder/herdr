...
pub(crate) use self::{
    ...
    modal::{
        handle_global_menu_key, handle_keybind_help_key, insert_keybind_help_query_text,
    ...
    navigator_reorder::reorder_direction_for_key,
    ...
    pub(super) async fn handle_key(
        ...
        match self.state.mode {
            ...
            _ => match self.state.mode {
                ...
                Mode::MoveWorktreeToWorkspace => self.handle_move_workspace_key(key_event),
                ...
                Mode::Navigator => self.handle_navigator_key_with_reorder(key_event),
