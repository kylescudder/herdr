...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        workspace_list_scrollbar_rect, workspace_parent_group_state, workspace_parent_index,
...
mod tests {
    ...
    fn expanded_sidebar_workspace_rows_show_state_before_name_without_numbers() {
        ...
        // Navigate mode with this row selected: the hover marker (❯) sits at the
        // left edge, then the state dot immediately before the name (no number).
